...
class PostReservation extends Component {
  ...
  pay = (e) => {
    ...
    axios.post(`${BASE_URL}/reservations`, data, { headers: { Authorization: localStorage.Token } }).then((res) => {
    ...
    return (
      <div>
        ...
        {this.props.activity.amount > 1 ? (
          <form>
            <div className="form-group">
              ...
              <input
                ...
                id="inputAddress"
                placeholder="The more the merrier remember..?"
              />
            </div>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                className="form-control"
                id="inputAddress2"
                placeholder="Tell us any special needs you may have... "
              />
            </div>

            <div className="form-group">
              <button className="btn btn-warning btn-block" onClick={this.pay}>
                {' '}
                Book{' '}
              </button>
            </div>
          ...
          <div className="form-group">
            <p>
              They say the best things in life are free, well that's true. We know you have been through alot and this
              is one the house, have a wonserful time and be refreshed
            </p>
